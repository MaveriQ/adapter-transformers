...
from ....models.lilt.modeling_lilt import (
...
@add_start_docstrings(
    """Lilt Model transformer with the option to add multiple flexible heads on top.""",
    LILT_START_DOCSTRING,
)
class LiltAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, LiltPreTrainedModel):
    ...
    head_types = {
        ...
        "pretraining": LiltPretrainingHead,
    ...
    def add_pretraining_head(self, head_name, activation_function="gelu", overwrite_ok=False):
        """
        Adds a Lilt Pretraining head on top of the model.
