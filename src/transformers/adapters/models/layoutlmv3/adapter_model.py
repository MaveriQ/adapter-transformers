...
from ....models.layoutlmv3.modeling_layoutlmv3 import (
...
@add_start_docstrings(
    """LayoutLMV3 Model transformer with the option to add multiple flexible heads on top.""",
    LAYOUTLMV3_START_DOCSTRING,
)
class LayoutLMV3AdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, LayoutLMV3PreTrainedModel):
    ...
    # used in ModelWithFlexibleHeadsAdaptersMixin
    head_types = {
        "classification": ClassificationHead, # Sequence classification
        "multilabel_classification": MultiLabelClassificationHead, # Sequence classification
        "tagging": TaggingHead, # Token classification
...
class LayoutLMV3ModelWithHeads(LayoutLMV3AdapterModel):
